import classes from './CheckboxOnYesOneDateCommentCard.module.scss';
...
import type { FormDataValues } from '@utils/utils.types';
...
const CheckboxOnYesOneDateCommentCard: FC<TaskActionFormProps> = ({ onClose, taskId, taskActionRequirements }) => {
    ...
    useEffect(() => {
        if (checkboxValue === 'no' || (checkboxValue === 'si' && isDateSubmitable && commentValue)) {
            setCanSubmit(true);
            return;
        }
        setCanSubmit(false);
    ...
    const handleSubmitForm = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        const taskActionData = {
            ...
            taskActionRequirements: {
                ...
                firstDateValue: formDataHolder.get('firstDateValue') as string,
    ...
    const isFormInvalid = ({ firstDateValue, commentValue }: FormDataValues): boolean => {
        return (
            isFormDatesInvalid(
                { firstDateValue },
                {
...
export default CheckboxOnYesOneDateCommentCard;
