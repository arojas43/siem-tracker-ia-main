import classes from './CompletedOperationTasksTable.module.scss';
...
import type { IncompletedOperationTasksTableProps } from '../IncompletedOperationTasksTable/IncompletedOperationTasksTable.types';

const CompletedOperationTasksTable: FC<IncompletedOperationTasksTableProps> = ({
    tasks,
    isLoading = false,
    showTable = true,
    onAction,
            ...
            >
                <td style={{ verticalAlign: 'middle' }}>
                    <input
                        ...
                        type="checkbox"
                        checked={true}
                        className={classes['operation-task-table__checkbox']}
                    />
                </td>
    ...
    return (
        <div hidden={!showTable}>
            <div className={classes['operation-task-table__header']}>
                <h4>Tareas de la fase completadas</h4>
            </div>
            <Table hover>
                <thead>
                    <tr>
...
export default CompletedOperationTasksTable;
...
// import Image from 'react-bootstrap/Image';
// import Placeholder from 'react-bootstrap/esm/Placeholder';
// import { CompletedOperationTasksTableProps } from './CompletedOperationTasksTable.types';
// import { TaskActionType } from '@store/api/api.types';
// import { TaskActionRequirements } from '../TaskActionsComponents/TaskActionsComponents.types';

// const CompletedOperationTasksTable: FC<CompletedOperationTasksTableProps> = ({
//     tasks,
//     isLoading = false,
//     showTable = true,
//     onAction,
...
//         return tasks.map(({ taskTitle, taskActionType, taskActionRequirements, taskId }, index) => (
//             <tr
//                 style={{ textAlign: 'center' }}
//                 key={index}
//             >
